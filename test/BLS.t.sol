...
contract BLSTest is Test {
    ...
    function testHashToField() public {
        ...
        assertEq(p[0], 6377005319755029317423923175346017268263799714680654249357570161824257486119);
        assertEq(p[1], 18480110343383522005003584307395342231571306117028543353120909280679762055539);
    }

    function testHashToPoint() public {
        uint256[2] memory p = bls.hashToPoint(DOMAIN, "1337");
        assertEq(p[0], 17059131175658094674393434650353656795956061013659379948338658822417682110884);
        assertEq(p[1], 702210538346082678531429435281574685788440235866651491455109452530350967102);
    }
